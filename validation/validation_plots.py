...
"""
Photo-z validation plots

Authors: Julia Gschwend, Matias Carrasco, Aurelio Carnero, Ricardo Ogando DES-Brazil
...
photoz_metrics.py config_plot.yaml

-help
Also see the ipython notebook, called ValidationplotsExample.ipynb
if you run
./validation_plots.py
